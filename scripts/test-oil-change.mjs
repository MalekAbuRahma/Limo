...
assert(OIL_DEFAULT_DISTANCE_KM === 7000, 'default distance 7000');
assert(computeNextOdometer(13000, 7000) === 20000, 'first record next odometer');
assert(computeNextOdometer(20000, 7000) === 27000, 'chained record next odometer');
...
assert(sumOilChangeCosts(oils) === 45, 'sum oil costs for summary');
